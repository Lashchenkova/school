 ...
 * Students
 *
 * @ORM\Table(name="students", uniqueConstraints={@ORM\UniqueConstraint(name="users_id_2", columns={"users_id"})}, indexes={@ORM\Index(name="users_id", columns={"users_id"}), @ORM\Index(name="ClassNumber", columns={"ClassNumber"})})
 * @ORM\Entity
 */
class Students
{
